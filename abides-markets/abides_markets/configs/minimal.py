...
LMM_NB_AGENTS = 1
LMM_TOTAL_LIQUIDITY = 0.1 * LOT_SIZE
LMM_STEP_SIZE_RATIO = 0.01 / 100
LMM_MAX_LEVELS = 1
LMM_IMBALANCE_BETA = 1.0
LMM_SAMPLING_FREQ = str_to_ns("30s")
LMM_TRADE_ARRIVAL_INTERVAL = str_to_ns("30s")
